...
class DefaultDmlStatementGenerator implements DMLStatementGenerator{
	protected SqlStatementGenerateHelper helper = new SqlStatementGenerateHelper();
	
	@Override
	public String asEntity(TableMeta meta){
		return "select " + 
	...
	@Override
	public String asKey(TableMeta meta){
		return "select " + 
	...
	static class SqlStatementGenerateHelper {
		/**
		 * generate statement:
